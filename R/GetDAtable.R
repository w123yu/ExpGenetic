...
#'
#' @return A dataframe. The output results contain the value of "|d/a|" and grouping results for each miRNA/siRNA/gene expressed in all species (average_rpm >= rpm_threshold).
#' @export
#' @examples
